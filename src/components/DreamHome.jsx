...
//   return (
//     <div className="relative w-full px-4 lg:px-[53px]">
//       <img
//         src="./Hero1.png"
//         alt="Dream Home"
//         className="hidden xl:block w-full mx-auto rounded"
//       />
//       <div className="absolute top-1 xl:top-10 left-1/2 2xl:top-20 transform -translate-x-1/2 text-center text-white space-y-1 md:space-y-4 ">
//         <div className="font-poppins font-bold text-xs  md:text-3xl  xl:text-[48px] 2xl:text-6xl leading-[100%] tracking-[0] text-center whitespace-nowrap">
//           Find Your Dream Home in One Click!
//         </div>

//         <div className="font-poppins font-normal text-xs  lg:text-[20px] 2xl:text-3xl leading-[100%] tracking-[0] text-center text-[#EEEEEE]">
//           Discover, Buy, or Rent Verified Properties with Ease.
//         </div>
//       </div>

//       {/* Search box */}
//       <div className="absolute md:top-[180px] md:left-[40px] md:right-[40px] lg:top-[200px] lg:left-[80px] lg:right-[80px] xl:top-[380px] xl:left-[157px] xl:right-[157px] 2xl:top-[700px] flex flex-col md:flex-row justify-between items-center">
//         <div
//           className="border border-amber-600 md:px-[41px] md:py-[17px] bg-white rounded-2xl w-[300px]  md:w-[400px] lg:w-[600px]  2xl:w-[800px]
//              font-poppins font-normal text-[20px] leading-[100%] flex  md:flex-row justify-between items-center relative"
//         >
...
//              placeholder:leading-[100%] placeholder:text-[#979797] focus:outline-none"
//             />
//           </div>
...
//         <div>
//           <button className="font-poppins font-normal text-[18px] leading-[100%] text-center text-[#1E3A8A] border border-[#1E3A8A] rounded-3xl px-5 py-[10px] bg-white">
//             List your property
//           </button>
//         </div>
//       </div>
...
//       {/* filters below */}
//       <div className="absolute top-[480px] left-[167px] right-[167px] py-5 px-8 bg-white shadow-lg rounded-4xl grid grid-cols-4 gap-4">
//         <select className="w-full px-4 py-4 border border-gray-300 rounded-4xl font-poppins text-[16px] text-[#1E1E1E] focus:outline-none focus:ring-2 focus:ring-[#1E3A8A]">
...
//         <button className="w-full bg-[#1E3A8A] text-white px-6 py-4 rounded-4xl font-poppins text-[16px] hover:bg-[#162d66] transition">
//           Find Property
//         </button>
//       </div>
//     </div>
